...
const art = JSON.parse(readFileSync("out/PublicRouter.sol/PublicRouter.json","utf8"));
...
console.log("PublicRouter:", r.contractAddress, "status", r.status);
const f = "deploy/mainnet.json";
const d = JSON.parse(readFileSync(f,"utf8")); d.publicRouter = r.contractAddress; writeFileSync(f, JSON.stringify(d,null,2));
console.log("wrote deploy/mainnet.json publicRouter");
